...
**Note:** As of 2026-02-21 nrepl was removed; the MCP uses Swank only (86 tools).

### Summary

CL-TRON-MCP is a fully functional MCP server for SBCL debugging with 86 tools across 14 categories.
...
- ✓ Debugger state tracking (_debugger-thread_, _debugger-level_)
...
- Unit tests: All pass
- Integration tests: Swank integration tests pass (requires Swank server on port 4006)
...
- HTTP transport uses Hunchentoot and is supported; stdio remains primary for AI clients.
- WebSocket transport is a placeholder.

### Protocol Clarification

- **Swank**: Used by Slime/Portacle/Sly - sexp messages with 6-char hex length prefix
